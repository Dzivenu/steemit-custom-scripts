...
// @steemradio
    ...
    if (window.location.href.indexOf("submit.html") > -1) {
        $('.Header__top.header .columns:first-child ul.menu > li:first-child').fadeIn(200).attr('id','steemradio').html('<a href="#steemradio"><img src="https://steemitimages.com/300x48/https://steemitimages.com/DQmNvNEqwbFjYAL5FbJTVPRj3uFeqDxQ8Ap6q7ZEH7uQcKt/steemradio-logo-eapo.gif"></a>');
    } else {
    }
    var content = [
    ...
    $('#steemradio > *').live('click', function(e) {
        e.preventDefault();
		$('.SubmitPost textarea').val(content).focus().get(0).setSelectionRange(0,0);
	});
